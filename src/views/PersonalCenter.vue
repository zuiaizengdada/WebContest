      ...
      <main class="personalcenter-main">
        ...
        <div class="personalcenter-title">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation" ref="contact">
              <a
                class="nav-link"
        ...
        <div class="tab-content" id="pills-tabContent">
          ...
          >
            <InformationBox>
              <span slot="title" class="title1">常用联系人</span>
              <div slot="box-main" class="contact">
                <table class="table">
                  <thead>
                    <tr>
                              ...
                              <div class="modal-body">
                                <form>
                                  <div class="form-group">
                                    <label for="moren" class="col-form-label"
                                      >默认联系人</label
                                    >
                                    <input
                                      type="text"
          ...
          >
            <InformationBox>
              <span slot="title" class="title4">个人收藏</span>
              <div slot="box-main" class="collection">
                <table class="table">
                  <thead>
                    <tr>
          ...
          >
            <InformationBox>
              <span slot="title" class="title2">个人信息设置</span>
              <div slot="box-main" class="setting">
          ...
          >
            <InformationBox>
              <span slot="title" class="title3">账户充值</span>
              <div slot="box-main" class="wallet">
                <div class="balance">
                  当前电子钱包账户余额为：￥{{ balance }}
                </div>
                <div class="recharge">
